...
static rosidl_typesupport_introspection_c__MessageMember ParameterDescriptor__rosidl_typesupport_introspection_c__ParameterDescriptor_message_member_array[8] = {
  {
    "name",  // name
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, rcl_interfaces, msg, ParameterDescriptor)() {
  ...
  ParameterDescriptor__rosidl_typesupport_introspection_c__ParameterDescriptor_message_member_array[7].members_ =
