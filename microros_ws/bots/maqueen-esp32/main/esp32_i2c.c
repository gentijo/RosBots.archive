 ...
 */
esp_err_t __attribute__((unused)) i2c_master_read_slave(i2c_port_t i2c_port, uint8_t dev_addr, uint8_t *data_rd, size_t size)
{
    if (size == 0) {
        return ESP_OK;
    }
 ...
 */
esp_err_t __attribute__((unused)) i2c_master_write_slave(i2c_port_t i2c_port, uint8_t dev_addr, uint8_t *data_wr, size_t size)
{
    i2c_cmd_handle_t cmd = i2c_cmd_link_create();
    i2c_master_start(cmd);
 ...
 */
esp_err_t i2c_master_init(uint8_t i2c_port)
{
 ...
 */
esp_err_t i2c_slave_init(uint8_t i2c_port)
{
    ...
    return i2c_driver_install(i2c_port, conf_slave.mode, I2C_SLAVE_RX_BUF_LEN, I2C_SLAVE_TX_BUF_LEN, 0);
}
